...
@onready var segment_title = $SegmentTitle   # создайте отдельную сцену SegmentTitle
@onready var hint_system = $HintSystem       # создайте отдельную сцену HintSystem
